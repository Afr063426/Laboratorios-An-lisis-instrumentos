...
grafico1(bono1$Fecha.de.evaluación[1:262],bono1$YAS_BOND_YLD[1:262])
...
grafico2(bono2$Fecha.de.evaluación[bono2$Fecha.de.evaluación<=as.Date('2020-03-16')],bono2$INT_ACC.2[bono2$INT_ACC.2<=as.Date('2020-03-16')],bono2$TOTAL[bono2$TOTAL<=as.Date('2020-03-16')], bono2$Gcapital[bono2$Gcapital<=as.Date('2020-03-16')] )
